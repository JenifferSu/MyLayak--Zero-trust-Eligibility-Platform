...
function Paragraph() {
  return (
    <div className="absolute h-[24px] left-0 top-[-2px] w-[136.32px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Black',sans-serif] leading-[24px] left-0 not-italic text-[24px] text-nowrap text-white top-0 whitespace-pre">My Eligibility Wallet</p>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="absolute h-[28px] left-0 top-[31px] w-[191.445px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Bold',sans-serif] leading-[28px] left-0 not-italic text-[18px] text-[rgba(255,255,255,0.7)] text-nowrap top-[0.5px] whitespace-pre">Your verified credentials</p>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="absolute h-[24px] left-[-1.48px] top-0 w-[104.961px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Bold',sans-serif] leading-[24px] left-[52.5px] not-italic text-[16px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">Student Status</p>
    </div>
  );
}
...
function Container6() {
  return (
    <div className="absolute bg-[rgba(5,223,114,0.2)] h-[28px] left-[113.92px] rounded-[1.67772e+07px] top-0 w-[90.727px]" data-name="Container">
      <CheckCircleIcon />
      <Paragraph4 />
    </div>
  );
...
function Paragraph8() {
  return (
    <div className="absolute h-[24px] left-[0.45px] top-0 w-[176.102px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Bold',sans-serif] leading-[24px] left-[88.5px] not-italic text-[16px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">B40 Household Eligibility</p>
    </div>
  );
}
...
function Container15() {
  return (
    <div className="absolute bg-[rgba(5,223,114,0.2)] h-[28px] left-[198.5px] rounded-[1.67772e+07px] top-0 w-[90.727px]" data-name="Container">
      <CheckCircleIcon1 />
      <Paragraph9 />
    </div>
  );
...
function Paragraph13() {
  return (
    <div className="absolute h-[24px] left-[-0.92px] top-0 w-[129.844px]" data-name="Paragraph">
      <p className="absolute font-['Arial:Bold',sans-serif] leading-[24px] left-[65px] not-italic text-[16px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">Regional Eligibility</p>
    </div>
  );
}
...
function Container24() {
  return (
    <div className="absolute bg-[rgba(5,223,114,0.2)] h-[28px] left-[149.5px] rounded-[1.67772e+07px] top-0 w-[90.727px]" data-name="Container">
      <CheckCircleIcon2 />
      <Paragraph14 />
    </div>
  );
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[147.344px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid h-[20px] relative w-[147.344px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[20px] left-[74px] not-italic text-[#1c398e] text-[14px] text-center text-nowrap top-0 translate-x-[-50%] whitespace-pre">View Available Services</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[205.445px]" data-name="Paragraph">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid h-[20px] relative w-[205.445px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[20px] left-[103px] not-italic text-[14px] text-center text-nowrap text-white top-0 translate-x-[-50%] whitespace-pre">{`Check Application `}</p>
      </div>
    </div>
  );
}
