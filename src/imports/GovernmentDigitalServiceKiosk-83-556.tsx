import svgPaths from "./svg-a84b5tyf2v";
import imgImage from "figma:asset/df2f6be404215777d6a9ff32bce3eee7cf6f3052.png";

function Image() {
  return (
    <div className="absolute h-[770px] left-0 top-0 w-[1069px]" data-name="Image">
...
function Container() {
  return <div className="absolute bg-[rgba(0,0,0,0.2)] h-[770px] left-0 top-0 w-[1069px]" data-name="Container" />;
}

function Container1() {
  return (
    <div className="absolute h-[770px] left-0 top-0 w-[1069px]" data-name="Container">
      <Image />
      <Container />
    </div>
  );
...
function Container3() {
  return (
    <div className="absolute content-stretch flex h-[60px] items-center justify-between left-[48px] top-[48px] w-[973px]" data-name="Container">
      <Container2 />
      <Button />
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[101.922px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid h-[24px] relative w-[101.922px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[51px] not-italic text-[16px] text-center text-nowrap text-white top-[-2px] translate-x-[-50%] whitespace-pre">Student Status</p>
      </div>
    </div>
  );
}
...
function Paragraph1() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[86px] not-italic text-[16px] text-[rgba(255,255,255,0.6)] text-center text-nowrap top-[-6px] translate-x-[-50%] whitespace-pre">Currently enrolled student</p>
    </div>
  );
}
...
function Container11() {
  return (
    <div className="absolute content-stretch flex gap-[24px] h-[80px] items-center left-[33px] top-[33px] w-[907px]" data-name="Container">
      <Container4 />
      <Container7 />
      <Container10 />
    </div>
...
function Button1() {
  return (
    <div className="bg-[rgba(255,255,255,0.1)] h-[146px] relative rounded-[24px] shrink-0 w-full" data-name="Button">
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[175.195px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid h-[24px] relative w-[175.195px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[88.5px] not-italic text-[16px] text-center text-nowrap text-white top-[-2px] translate-x-[-50%] whitespace-pre">B40 Household Eligibility</p>
      </div>
    </div>
  );
}
...
function Paragraph2() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[127.5px] not-italic text-[16px] text-[rgba(255,255,255,0.6)] text-center text-nowrap top-[-6px] translate-x-[-50%] whitespace-pre">Qualified household income bracket</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[128.93px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid h-[24px] relative w-[128.93px]">
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[64px] not-italic text-[16px] text-center text-nowrap text-white top-[-2px] translate-x-[-50%] whitespace-pre">Regional Eligibility</p>
      </div>
    </div>
  );
}
...
function Paragraph3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Paragraph">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[86.5px] not-italic text-[16px] text-[rgba(255,255,255,0.6)] text-center text-nowrap top-[-6px] translate-x-[-50%] whitespace-pre">Location-based services</p>
    </div>
  );
}
...
function Container28() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[24px] h-[486px] items-start left-[48px] top-[140px] w-[973px]" data-name="Container">
      <Button1 />
      <Button2 />
      <Button3 />
    </div>
...
function Button4() {
  return (
    <div className="absolute bg-[#ffb900] content-stretch flex h-[64px] items-center justify-center left-[396.79px] px-[64px] py-[8px] rounded-[14px] top-[658px] w-[275.414px]" data-name="Button">
...
function EligibilityWallet() {
  return (
    <div className="absolute h-[770px] left-0 top-0 w-[1069px]" data-name="EligibilityWallet">
      <Container3 />
      <Container28 />
      <Button4 />
    </div>
